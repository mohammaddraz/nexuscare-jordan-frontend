...
import { Plus, User, FileText, CheckCircle2, Clock } from 'lucide-react';
          ...
          <div className="card glass-panel animate-fadeIn" key={activeDependentId}>
            <div className="card-body p-4 p-md-5">
              ...
              <div className="d-flex gap-2">
                <Button variant="outline-primary" size="sm" href="/consumer/medical-records" className="d-flex align-items-center gap-2">
