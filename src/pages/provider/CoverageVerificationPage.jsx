          ...
          <div className="card glass-panel mb-4 animate-fadeInUp">
            <div className="card-body p-4 p-md-5 text-center">
              <div className="mx-auto mb-4 rounded-circle d-flex align-items-center justify-content-center"
                   style={{ width: 64, height: 64, backgroundColor: 'rgba(0, 106, 97, 0.08)' }}>
                <ShieldCheck size={32} color="var(--color-brand-secondary)" />
              </div>
              <h4 className="fw-bold mb-3">Check Patient Eligibility</h4>
              <p className="text-muted mb-4" style={{ fontSize: '0.9rem', maxWidth: 400, margin: '0 auto' }}>
                Enter a 10-digit Jordanian National ID to securely query the MOH central registry for active coverage.
              </p>
              
              <Form onSubmit={handleVerify} className="max-w-md mx-auto" style={{ maxWidth: 400, margin: '0 auto' }}>
                <InputGroup className="mb-3 input-group-lg shadow-sm">
                  ...
                  <Form.Control
                    ...
                    className="border-start-0 ps-0 text-center font-mono fw-bold"
            ...
            <div className="card border-0 shadow-lg animate-scaleIn overflow-hidden">
              ...
              <div className="card-body p-4 p-md-5 bg-white">
                <div className="d-flex align-items-center gap-4 mb-4 pb-4 border-bottom">
                  <div className="rounded-circle d-flex align-items-center justify-content-center bg-light" style={{ width: 80, height: 80 }}>
                    <User size={40} color="var(--color-text-muted)" />
                  </div>
                  <div>
                    <p className="text-muted text-uppercase mb-1" style={{ fontSize: '0.7rem', fontWeight: 700, letterSpacing: '0.1em' }}>Patient Profile</p>
                    <h3 className="fw-bold mb-1" style={{ color: 'var(--color-brand-primary)' }}>{result.data.name}</h3>
                ...
                <div className="row g-4">
                  <div className="col-sm-6">
                    <div className="p-3 bg-light rounded-3 border">
                      <p className="text-muted text-uppercase mb-1" style={{ fontSize: '0.65rem', fontWeight: 700 }}>Contract Tier</p>
          ...
          {result && result.status === 'not-found' && (
            <div className="card border-0 shadow-lg animate-scaleIn overflow-hidden">
              ...
              <div className="card-body p-4 text-center bg-white">
                <p className="fw-bold mb-2" style={{ fontSize: '1.1rem' }}>No active insurance found for ID: {nationalId}</p>
